...
v2ray() {
  ...
  WireguardURL="wireguard://$(urlencode "$PrivateKey")@$Endip_v46?address=$(urlencode "$Address")&publickey=$(urlencode "$PublicKey")&mtu=$(urlencode "$MTU")#👹__ЯΞZΛ___WireGuard"
...
clear
echo -e "${cyan}By --> 👹__ЯΞZΛ__ * Github.com/Ptechgithub * ${rest}"
echo ""
echo -e "${purple}*********************${rest}"
