...
cfwarpreg(){
curl -sSL https://raw.githubusercontent.com/Reza_sal/WarpScanner/main/point/acwarp.sh -o acwarp.sh && chmod +x acwarp.sh && ./acwarp.sh
}
...
if [[ -n $cpu ]]; then
curl -L -o warpendpoint -# --retry 2 https://raw.githubusercontent.com/Reza_sal/WarpScanner/main/point/$cpu
fi
}
...
echo "------------------------------------------------------"
echo "my name's  ：👹__ЯΞZΛ__"
echo "Telegram id: Rsae63"
